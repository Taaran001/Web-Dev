...
const registerUser = asyncHandler(async (req, res) => {
    ...
    // console.log("log existedUser:- ", existedUser);
    ...
    if (!avatarLocalPath) {
        throw new ApiError(400, "Avatar file is required 4")
    }
    ...
    if (!avatar) {
        throw new ApiError(400, "Avatar file is required 5")
    }
...
const updateUserAvatar = asyncHandler (async(req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, user, "new Avatar is uploaded"))
})
...
const updateUserCoverImage = asyncHandler (async(req, res) => {
    ...
    const user = await User.findByIdAndUpdate(
        ...
        return res.status(200).json(new ApiResponse(200, user, "new Cover image is uploaded"))
...
const getWatchHistory = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, user[0].watcHistory, "Watch history fetched!"))
})
